...
import { FaCheckCircle, FaImage, FaPlane, FaFileContract, FaAward } from "react-icons/fa";

gsap.registerPlugin(ScrollTrigger);

// ... (Interface Code remains the same) ...
interface Post {
  _id: string;
  title: string;
  slug: { current: string };
...
export default function Home() {
  ...
  return (
    <main ref={container} className="w-full relative bg-c2white font-sans">
      ...
      {/* 4. PROCESS SECTION (NEW CONTENT) */}
      <section className="py-24 bg-white px-8">
        <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
                <h2 className="text-c2blue font-bold tracking-widest uppercase mb-2">The Process</h2>
                <h3 className="text-4xl font-bold font-heading text-c2black">Your Path to Flight</h3>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {/* Step 1 */}
                <div className="p-8 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
                    <div className="w-16 h-16 bg-c2blue/10 rounded-full flex items-center justify-center text-c2blue text-2xl mb-6">
                        <FaFileContract />
                    </div>
                    <h4 className="text-xl font-bold mb-3">1. Consultation</h4>
                    <p className="text-gray-600">We analyze your operational needs and identify the specific GCAA permits required.</p>
                </div>
                {/* Step 2 */}
                <div className="p-8 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
                    <div className="w-16 h-16 bg-c2blue/10 rounded-full flex items-center justify-center text-c2blue text-2xl mb-6">
                    ...
                    <h4 className="text-xl font-bold mb-3">2. Compliance & Audit</h4>
                    <p className="text-gray-600">Our team prepares your manuals, safety protocols, and GCAA documentation for submission.</p>
                </div>
                {/* Step 3 */}
                <div className="p-8 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
                    <div className="w-16 h-16 bg-c2blue/10 rounded-full flex items-center justify-center text-c2blue text-2xl mb-6">
                    ...
                    <h4 className="text-xl font-bold mb-3">3. Certification</h4>
                    <p className="text-gray-600">We manage the approval process until you receive your Permit or ROC. Ready for takeoff.</p>
                </div>
            </div>
        </div>
      </section>
      ...
      <section ref={pinSection} className="min-h-screen w-full bg-gray-50 flex items-center justify-between px-6 md:px-20 overflow-hidden relative py-20">
        <TechBackground />
        <div className="w-full md:w-1/2 flex flex-col justify-center md:pl-10 z-10 pointer-events-none">
           <h2 className="text-5xl font-bold font-heading text-c2black mb-6 drop-shadow-sm">
